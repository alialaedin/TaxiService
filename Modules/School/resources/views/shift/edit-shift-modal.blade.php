@foreach ($shifts as $shift)
  <div class="modal fade" id="editShiftModal-{{ $shift->id }}" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content modal-content-demo">
        <div class="modal-header">
          <p class="modal-title" style="font-size: 20px;">ویرایش شیفت - کد {{ $shift->id }}</p><button aria-label="Close" class="close" data-dismiss="modal"><span aria-hidden="true">×</span></button>
        </div>
        <div class="modal-body">
          <form action="{{ route('admin.shifts.update', $shift) }}" method="post" class="save">
            @csrf
            @method('PATCH')
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" id="title" class="form-control" name="title" value="{{ old('title', $shift->title) }}">
