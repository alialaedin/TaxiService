...
@section('content')
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <x-core::delete-button
                      route="admin.education-levels.destroy"
                      :model="$educationLevel"
                      disabled="{{ !$educationLevel->isDeletable() }}"
                    />
                  </td>
                </tr>
              @empty
  ...
  @include('school::education-level.create-education-level-modal')
  @include('school::education-level.edit-education-level-modal')
