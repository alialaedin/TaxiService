...
@section('content')
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <x-core::delete-button
                      route="admin.school-types.destroy"
                      :model="$schoolType"
                      disabled="{{ !$schoolType->isDeletable() }}"
                    />
                  </td>
                </tr>
              @empty
  ...
  @include('school::school-type.create-school-type-modal')
  @include('school::school-type.edit-school-type-modal')
