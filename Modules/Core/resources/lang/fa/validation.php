...
return [
    ...
    */
	'attributes' => [
		...
		'patient_national_code' => 'کد ملی مریض',
		'document_number' => 'شماره سند',
		'operations' => 'عمل ها',
		'surgeried_at' => 'تاریخ عمل',
		'released_at' => 'تاریخ ترخیص',
		'doctors' => 'دکتر ها',
		'basic_insurance_id' => 'بیه پایه',
		'supp_insurance_id' => 'بیه تکمیلی',
		'doctor_surgery_ids' => 'عمل های جراحی',
	],
];
