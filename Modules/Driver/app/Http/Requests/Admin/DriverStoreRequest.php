...
class DriverStoreRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    return [
      ...
      'mobile' => ['required', new IranMobile(), Rule::unique('drivers', 'mobile')],
      'national_code' => ['required', 'digits:10', Rule::unique('drivers', 'national_code')],
      ...
      'license_image' => ['required', File::types(Driver::ACCEPTED_LICENSE_MIME_TYPES)->max(2048)],
      'driver_image' => ['required', File::types(Driver::ACCEPTED_IMAGE_MIME_TYPES)->max(2048)],
    ];
  }
