...
@section('content')
    ...
    <ol class="breadcrumb align-items-center">
      <li class="breadcrumb-item">
        <a href="{{ route('company.drivers.index') }}">
          <i class="fa fa-car ml-1"></i> لیست راننده ها
        </a>
      </li>
  ...
  <div class="card">
    <div class="card-header">
      <p class="card-title">ویرایش راننده - کد {{ $driver->id }}</p>
      <x-core::card-options/>
    </div>
    <div class="card-body">
      <form action="{{ route('company.drivers.update', $driver) }}" method="post" class="save" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <input type="hidden" name="company_id" value="{{ auth('company-web')->user()->id }}"/>
            ...
            <div class="form-group">
              ...
              <select name="gender" id="gender" class="form-control">
                @foreach($genders as $name => $label)
                  <option value="{{ $name }}"
                    @selected(old('gender', $driver->gender) == $name)>
                    {{ $label }}
                  </option>
                @endforeach
              </select>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-12">
            <div class="form-group">
              <label for="driver_image" class="control-label">تصویر راننده :</label>
              <input
                type="file"
                id="driver_image"
                class="form-control"
                name="driver_image"
                value="{{ old('driver_image', $driver->driver_image) }}"
              />
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-12">
            <div class="form-group">
              <label for="license_image" class="control-label">تصویر مجوز :</label>
              <input
                type="file"
                id="license_image"
                class="form-control"
                name="license_image"
                value="{{ old('license_image', $driver->license_image) }}"
              />
            ...
            <div class="form-group">
              ...
              <select name="car_type" id="car_type" class="form-control">
                @foreach($carTypes as $name => $label)
                  <option value="{{ $name }}" @selected(old('car_type', $driver->car_type) == $name)>{{ $label }}</option>
                @endforeach
              </select>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-12">
            <div class="form-group">
              ...
              <input
                ...
                value="{{ old('car_name', $driver->car_name) }}"
                required autofocus
              />
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-12">
            <div class="form-group">
              ...
              <input
                ...
                value="{{ old('car_color', $driver->car_color) }}"
                required autofocus
              />
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-12">
            <div class="form-group">
              ...
              <input
                ...
                value="{{ old('card_number', $driver->card_number) }}"
                required autofocus
              />
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-12">
            <div class="form-group">
              ...
              <input
                ...
                value="{{ old('sheba_number', $driver->sheba_number) }}"
                required autofocus
              />
          ...
          <div class="col-md-3 col-12">
            <div class="form-group">
              ...
              <input
                ...
                type="hidden"
                required
                value="{{	old('license_expiration_date', $driver->license_expiration_date) }}"
              />
          ...
          <div class="col-12">
            <div class="form-group">
              ...
              <textarea
                ...
                required>{{ old('description', $driver->description) }}
              </textarea>
