...
@section('content')
  ...
  <div class="card">
    <div class="card-body">
      <form action="{{ route('company.drivers.store') }}" method="post" class="save" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-12">
            <div class="form-group">
              <label for="driver_image" class="control-label">تصویر راننده :<span class="text-danger">&starf;</span></label>
              <input
                type="file"
                id="driver_image"
                class="form-control"
              ...
              />
              <span class="d-block fs-10 mt-1 mr-1 text-muted-dark">
                تایپ فایل های قابل قبول : {{ $acceptedDriverImageMimes }}
              </span>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-12">
            <div class="form-group">
              <label for="license_image" class="control-label">تصویر مجوز :<span class="text-danger">&starf;</span></label>
              <input
                type="file"
                id="license_image"
                class="form-control"
              ...
              />
              <span class="d-block fs-10 mt-1 mr-1 text-muted-dark">تایپ فایل های قابل قبول :
